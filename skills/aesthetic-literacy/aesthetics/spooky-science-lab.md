---
slug: spooky-science-lab
label: Spooky Science Lab
family: technical-institutional
era: K-12 seasonal STEM materials; contemporary
aliases: ["Halloween science lab", "spooky STEM"]
status: canonical
...
Spooky Science Lab blends classroom STEM with Halloween play: beakers, specimen labels, safety signage, chalkboard formulas, and bubbling experiment cues. It should feel playful and educational without drifting into real hazard confusion.

## Scope

Use Spooky Science Lab when the product context can credibly support its source artifacts and seasonal logic. The aesthetic should operate as an information system, not a mood-board layer: preserve its native labels, surfaces, display conventions, and hierarchy before adding decorative motifs.
...
**Cultural markers**: Key markers include beakers, specimen labels, safety signage, chalkboard formulas. Treat these as contextual signals, not interchangeable clip art.

## Non-Negotiables

**Non-negotiables**: beakers + specimen labels + safety signage. Removing these usually collapses the entry into nearby fall, horror, classroom, retail, or craft aesthetics.
