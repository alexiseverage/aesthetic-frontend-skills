...
Canonical entries are stored inside the installed literacy skill at
`aesthetic-literacy/aesthetics/<slug>.md`. Root `knowledge/aesthetics/` profiles are
optional provenance and maintenance resources, not the default app-design path.
```
...
aesthetic-literacy, aesthetic-application.

Canonical entries are stored inside the installed literacy skill at
`aesthetic-literacy/aesthetics/<slug>.md`. Optional provenance profiles may live in
`~/.agents/skills/knowledge/aesthetics/` (user/global install) or
`knowledge/aesthetics/` at this project root.
```
...
- The optional `knowledge/aesthetics/` directory only needs to be scaffolded if you maintain provenance profiles.
